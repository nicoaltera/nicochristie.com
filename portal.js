...
<header class="masthead">
 ...
 <div class="identity"><div class="name-row"><canvas class="fried-fire" width="48" height="64" aria-label="Animated flame" role="img"></canvas><h1 data-text="Nico Christie"><span>Nico Christie</span></h1></div><div class="tagline">practice. practice. practice</div></div>
...
<div class="portal-grid">
 ...
 <section class="main-column">
  <div class="sunset"><span>Welcome to my corner of the web</span><strong>Nico Christie's personal site</strong></div>
 ...
 <aside class="right-rail">
  ...
  <section class="bevel inline-mines" aria-label="Playable Minesweeper"><div class="popup-title"><span>Minesweeper</span><span aria-hidden="true">💣</span></div><div class="minesweeper" data-inline="true"></div></section><div class="wall-gallery side-art" id="wall-right" aria-label="Visitor art, right wall"></div><div class="sand-trail-note"><svg viewBox="0 0 210 215" aria-hidden="true"><defs><g id="sand-note-foot"><path d="M-5 0C-14 2-13 13-7 18C-3 22-8 29-4 34C0 39 8 35 8 29C9 22 15 13 12 6C9 0 1-3-5 0Z"/><ellipse cx="10" cy="-8" rx="4" ry="5"/><ellipse cx="2" cy="-10" rx="3" ry="4"/><ellipse cx="-5" cy="-8" rx="2.5" ry="3.5"/><ellipse cx="-11" cy="-4" rx="2" ry="3"/></g></defs><use href="#sand-note-foot" transform="translate(40 18) rotate(-30) scale(1 1)"/><use href="#sand-note-foot" transform="translate(82 45) rotate(-21) scale(-1 1)"/><use href="#sand-note-foot" transform="translate(67 81) rotate(-8) scale(1 1)"/><use href="#sand-note-foot" transform="translate(112 111) rotate(7) scale(-1 1)"/><use href="#sand-note-foot" transform="translate(104 150) rotate(17) scale(1 1)"/><use href="#sand-note-foot" transform="translate(145 177) rotate(30) scale(-1 1)"/></svg><span>I see you</span></div>
 </aside>
</div>
